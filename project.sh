...
echo 'PATH=$PATH:/opt/gradle/gradle-4.8.1/bin' >> .bashrc
cat .bashrc
...
ssh-agent bash -c 'ssh-add gitlab_selfcubric_keypair.key; git clone git@gitlab.cs.cf.ac.uk:c1722545/cubric.git'

echo "creating database..."
mysql -u root -pPassw0rd! < "cubric/sql scripts/database creation.sql"
...
java -jar cubric-0.0.1-SNAPSHOT.jar
